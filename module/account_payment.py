...
class InheritPayment(models.Model):
    ...
    def post(self):
        ...
        for rec in self:
            ...
            # write fake_amount are real amount with minus
            rec.write({'fake_amount':rec.amount})
    ...
    fake_amount = fields.Monetary(string="Payment Amount")
    isrefunds = fields.Boolean(string="isRefund?", default=False)